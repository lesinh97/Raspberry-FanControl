...
# Because Argon One case's script only work on Raspberry 4 running Raspian
# Modifications were made to work on Ubuntu 20.04
# This script was tested on a Raspberry Pi 4, with 4GB RAM and 32GB SD card
...
# Change python version to 3 in order to adapt with currently running python in Ubuntu
...
# This will result "/home/ubuntu/Desktop"
